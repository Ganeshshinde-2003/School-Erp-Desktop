...
export const signupAdminUser = async (userDetails) => {
    ...
    try {
        ...
        return { status: false, message: "An error occurred while adding the user" };
    }
};
...
export const loginAdminUser = async (userDetails) => {
    ...
    try {
        ...
        return { status: false, message: "An error occurred while verifying credentials" };
    }
};
    ...
    try {
        ...
        if (docSnapshot.exists()) {
            ...
            if (password === storedPassword) {
                ...
                return { status: false, message: "The password doesn't match or Invalid Credential" };
            }
        } else {
        ...
        return { status: false, message: "An error occurred while checking the password" };
    }
};
